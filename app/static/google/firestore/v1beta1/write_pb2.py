...
from app.static.google.firestore.v1beta1 import common_pb2 as google_dot_firestore_dot_v1beta1_dot_common__pb2
...
_WRITE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='update_transforms', full_name='google.firestore.v1beta1.Write.update_transforms', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='current_document', full_name='google.firestore.v1beta1.Write.current_document', index=5,
...
_WRITE.fields_by_name['update_transforms'].message_type = _DOCUMENTTRANSFORM_FIELDTRANSFORM
