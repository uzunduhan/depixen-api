...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/firestore/v1beta1/query.proto',
  ...
  ,
  dependencies=[google_dot_firestore_dot_v1beta1_dot_document__pb2.DESCRIPTOR,google_dot_protobuf_dot_wrappers__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,])
...
_STRUCTUREDQUERY = _descriptor.Descriptor(
  ...
  nested_types=[_STRUCTUREDQUERY_COLLECTIONSELECTOR, _STRUCTUREDQUERY_FILTER, _STRUCTUREDQUERY_COMPOSITEFILTER, _STRUCTUREDQUERY_FIELDFILTER, _STRUCTUREDQUERY_UNARYFILTER, _STRUCTUREDQUERY_FIELDREFERENCE, _STRUCTUREDQUERY_ORDER, _STRUCTUREDQUERY_PROJECTION, ],
  enum_types=[
...
_STRUCTUREDQUERY_FIELDFILTER.fields_by_name['value'].message_type = google_dot_firestore_dot_v1beta1_dot_document__pb2._VALUE
...
_CURSOR.fields_by_name['values'].message_type = google_dot_firestore_dot_v1beta1_dot_document__pb2._VALUE
...
StructuredQuery = _reflection.GeneratedProtocolMessageType('StructuredQuery', (_message.Message,), {
  ...
  'CollectionSelector' : _reflection.GeneratedProtocolMessageType('CollectionSelector', (_message.Message,), {
    ...
    '__module__' : 'google.firestore.v1beta1.query_pb2'
